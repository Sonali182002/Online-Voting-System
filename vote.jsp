						...
						<center>
							<form method="POST" action="VotingServlet">
								...
								<table cellspacing=0 cellpadding="10">
									<tr>
									<c:choose>
										<c:when test="${(user.vote).equalsIgnoreCase('BJP')}">
										<tr>	
											<td></td>
											<td align=left><input type="radio" name="vote" value="BJP"/>BJP</td>
										</tr>
										<tr>
											<td></td>
											<td align=left><input type="radio" name="vote"	value="CONGRESS"/>CONGRESS</td>
										</tr>
										<tr>
											<td></td>
											<td align=left><input type="radio" name="vote" value="AAP" />AAP</td>
										</tr>
										
										</c:when>
										<c:when test="${(user.vote).equalsIgnoreCase('CONGRESS')}">
											<tr>
												<td></td>
												<td align=left><input type="radio" name="vote" value="BJP"/>BJP</td>
											</tr>
